...
/**
 * read_dir - opens and reads diretory file names in searh of fil
 * @er: error message
 * @s: struct containing info about a file in a directory
...
/**
 * save_path - saves a copy of the PATAH string
